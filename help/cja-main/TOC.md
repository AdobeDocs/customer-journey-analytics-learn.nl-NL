...
+ Basisbegrippen voor Customer Journey Analytics {#cja-basics}
   ...
   + [Waarom CJA? Strategische herziening van CJA versus Adobe Analytics](cja-basics/why-cja-modernize-customer-analytics.md)
   + [Inleiding tot Customer Journey Analytics](cja-basics/understanding-customer-journey-analytics.md)
   + [Analyse aan CJA: Nieuwe termen en hoe ze worden toegewezen](cja-basics/new-terms-and-concepts-in-cja.md)
...
+ Customer Journey Analytics B2B edition {#b2b}
   + [Inleiding tot Customer Journey Analytics - B2B edition](b2b/cja-b2b-overview.md)
   + [CJA B2B edition - Meer dan de eerste vragen](b2b/cja-b2b-beyond-the-first-questions.md)
   + [CJA integreren met Marketo for B2B Insights](b2b/integrate-cja-with-marketo-for-b2b-insights.md)
...
+ Data Insights Agent {#data-insights-agent}
   ...
   + [Gebruiksscenario&#39;s](data-insights-agent/data-insights-agent-use-cases.md)
...
+ Analysis Workspace {#analysis-workspace}
   ...
   + Visualisaties {#visualizations}
      ...
      + [Meerdere dimensiekolommen in vrije-vormtabellen](analysis-workspace/visualizations/multiple-dimension-columns-in-freeform-tables.md)
      + [Lijnvisualisatie toevoegen](analysis-workspace/visualizations/line-visualization.md)
      + [De kaartvisualisatie toevoegen en configureren](analysis-workspace/visualizations/configure-and-use-the-map-visualization.md)
      + [Samenvattingsvisualisaties toevoegen](analysis-workspace/visualizations/use-summary-visualizations.md)
      + [Tekstvisualisatie toevoegen](analysis-workspace/visualizations/add-text-visualizations.md)
      + [Spreidingsvisualisaties toevoegen](analysis-workspace/visualizations/use-scatterplot-visualizations.md)
      + [Visualisaties voor boomstructuurmappen toevoegen](analysis-workspace/visualizations/add-treemap-visualizations.md)
   ...
   + Curven en delen {#curate-and-share}
      + [Gegevensopslag: diapresentaties genereren](analysis-workspace/curate-and-share/data-storytelling-generate-slides.md)
...
+ Exporteren {#exporting}
   ...
   + [Volledige tabelexport beheren en beheren](exporting/manage-full-table-exports.md)
...
+ Gebruiksscenario&#39;s {#use-cases}
   + Kunstmatige inlichtingen {#ai}
      + [AI-verkeer bijhouden en analyseren](use-cases/ai/track-and-analyze-ai-traffic.md)
